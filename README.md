...
**Ограничение:** на текущий момент на vercel не работает метод POST, поскольку файловая система, используемая в среде Vercel, предназначена только для чтения, а БД на текущий момент не развернута для приложения.
