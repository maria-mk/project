...
})({"kqbVR":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "1fe046d1e6794eb6";
"use strict";
...
},{}],"jzbyv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderStoresAndMap", ()=>renderStoresAndMap);
var _apiJs = require("./api.js");
// Создание компонента для одного магазина
const createStoreItemComponent = ({ storeNet, logo, storePrices })=>{
    const storeItem = document.createElement('li');
    storeItem.className = 'store-item';
    const addressOptions = storePrices.map(({ address })=>`<option>${address}</option>`).join('');
    ...
    storeItem.innerHTML = `
        <ul>
            ...
            <li class="store-info">
                ...
                <span class="price">${initialPrice} \u{440}\u{443}\u{431}</span>
            </li>
        </ul>
    `;
    ...
    selectElement.addEventListener('change', (event)=>{
        ...
        priceElement.textContent = `${selectedPrice} \u{440}\u{443}\u{431}`;
    });
    return storeItem;
};
...
const fetchGroupedStoresData = async (productId)=>{
    try {
        const product = await (0, _apiJs.getProductById)(productId);
        if (!product || !product.stores_id) {
            console.error("\u041F\u0440\u043E\u0434\u0443\u043A\u0442 \u0438\u043B\u0438 \u0441\u043F\u0438\u0441\u043E\u043A \u043C\u0430\u0433\u0430\u0437\u0438\u043D\u043E\u0432 \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D");
            return [];
        }
        const prices = await (0, _apiJs.getPriceByProductId)(productId);
        const storePromises = product.stores_id.map((storeId)=>(0, _apiJs.getStoreById)(storeId));
        const stores = await Promise.all(storePromises);
        // Группировка данных
        const groupedStores = stores.reduce((acc, store)=>{
            const storePrices = prices.filter((price)=>price.store_id === store.id).map((price)=>({
                    address: store.address,
                    price: price.price
                }));
            if (!acc[store.store_net]) acc[store.store_net] = {
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if (productId) renderStoresAndMap(productId);
    else console.error("ID \u043F\u0440\u043E\u0434\u0443\u043A\u0442\u0430 \u043D\u0435 \u0443\u043A\u0430\u0437\u0430\u043D \u0432 URL.");
});

},{"./api.js":"9u7qN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kqbVR","jzbyv"], "jzbyv", "parcelRequire94c2")

//# sourceMappingURL=page2.e6794eb6.js.map
