...
})({"eh6mD":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d84e76739896bf4b";
"use strict";
...
},{}],"cWysF":[function(require,module,exports,__globalThis) {
var expanded = false;
...
const renderFilters = ()=>{
    ...
    container.innerHTML = `
        ...
        "\u041A\u0440\u0435\u043F\u043B\u0435\u043D\u043E\u0435",
        "\u0414\u0435\u0441\u0435\u0440\u0442\u043D\u043E\u0435"
    ].map((type)=>`<button class="filter_text_button">${type}</button>`).join('')}
                </div>
            </li>
            <li>
        ...
        "\u0420\u043E\u0437\u043E\u0432\u043E\u0435",
        "\u041E\u0440\u0430\u043D\u0436\u0435\u0432\u043E\u0435"
    ].map((color)=>`<button class="filter_text_button">${color}</button>`).join('')}
                </div>
            </li>
            <li>
        ...
        "\u041F\u043E\u043B\u0443\u0441\u043B\u0430\u0434\u043A\u043E\u0435",
        "\u0421\u043B\u0430\u0434\u043A\u043E\u0435"
    ].map((sugar)=>`<button class="filter_text_button">${sugar}</button>`).join('')}
                </div>
            </li>
        </ul>
    `;
...
const initializeEventHandlers = ()=>{
    ...
    if (filterContainer) filterContainer.addEventListener('click', function(event) {
...
},{}]},["eh6mD","cWysF"], "cWysF", "parcelRequire94c2")

//# sourceMappingURL=index.9896bf4b.js.map
