...
var _storesJs = require("./stores.js");
var _reviewsJs = require("./reviews.js");
document.addEventListener('DOMContentLoaded', function() {
    ...
    function activateButton(activeButton) {
        document.querySelectorAll('.filter_text_button_big').forEach((button)=>button.classList.remove('filter_button--color-active'));
    ...
    whereToBuyButton.addEventListener('click', async function() {
        ...
        await (0, _storesJs.renderStoresAndMap)(productId); // Используем ID из URL
    });
    reviewsButton.addEventListener('click', async function() {
        activateButton(reviewsButton);
        console.log('\u041A\u043D\u043E\u043F\u043A\u0430 "\u041E\u0442\u0437\u044B\u0432\u044B" \u043D\u0430\u0436\u0430\u0442\u0430');
        await (0, _reviewsJs.renderReviewsSection)(productId); // Используем ID из URL
    });
});

},{"./stores.js":"jzbyv","./reviews.js":"fYIS4"}]},["aDUUU","dV6cC"], "dV6cC", "parcelRequire94c2")

//# sourceMappingURL=page2.e82f28a0.js.map
